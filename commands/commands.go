...
var cmds = map[string]core.Command{
	"app:serve":       NewServeCommand(),
	"make:controller": NewMakeControllerCommandCommand(),
}
...
func WrapSubCommand(name string, cmd core.Command, opt fx.Option) *cobra.Command {
